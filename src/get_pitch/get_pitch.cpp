...
Options:
    -p, --u_pot=REAL    Umbral de potencia para la determinación de sonoro/sordo [default: -60]
    -1, --u_r1=REAL     Umbral de la autocorrelación de 1 para la determinación de sonoro/sordo [default: 0.5]
